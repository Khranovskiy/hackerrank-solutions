...
int main ()
{
  ...
  return 0;
    ...
    let expected = `// my  program in C++
/** playing around in
a new programming language **/
//use cout`

    let outputStream = new streamBuffers.WritableStreamBuffer()
    ideIdentifyingComments(input, outputStream)
    outputStream.end()
...
The area of the circle is 7857.1429*/`
    let expected = `/*This is a program to calculate area of a circle after getting the radius as input from the user*/
...
int main()
{
    ...
    let expected = `/* Iterate through the list till we encounter the last node.*/
/* Allocate memory for the new node and put data in it.*/
